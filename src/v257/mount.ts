                                    ...
                                    el('div', { style: 'margin:0' }, [
                                        ...
                                        el('div.FLEX3', [
                                            ...
                                            el('div.BROWSER.CHROME', [
                                                ...
                                                el('h5', feature.data.origin === 'caniuse' && feature.data.chrome_android ? '?' : feature.data.chrome_android || '-'),
                                            ]),
                                            el('div.BROWSER.FIREFOX', [
                                                svg(
                                                    'svg',
                                                ...
                                                el('h5', feature.data.origin === 'caniuse' && feature.data.firefox_android ? '?' : feature.data.firefox_android || '-'),
                                            ]),
                                        ]),
                                    ]),
                                ],
                            ...
                            el('div.FLEX', [
                                ...
                                el('div.FLEX2', [
                                    el('div.BROWSER.CHROME', [
                                        ...
                                        isMobile && feature.data.origin === 'mdn' && svg(
                                            'svg.mobile',
                                            { viewBox: '0 0 24 24' },
                                            svg('use', { href: '#mobile' }),
                                        ),
                                        el('h5', feature.data[isMobile && feature.data.origin === 'mdn' ? 'chrome_android' : 'chrome'] || '-'),
                                    ]),
                                    el('div.BROWSER.FIREFOX', [
                                        svg(
                                            'svg',
                                        ...
                                        el('h5', feature.data[isMobile && feature.data.origin === 'mdn' ? 'firefox_android' : 'firefox'] || '-'),
                                    ]),
                                ]),
                            ]),
                        ],
