...
export const arrowFunction = {
    data: {"origin":"caniuse","title":"Arrow functions","description":"Function shorthand using `=>` syntax and lexical `this` binding.","chrome":"45","chrome_android":"142","firefox":"22","firefox_android":"144","url":"https://caniuse.com/arrow-functions"},
	key: 'arrowFunction',
...
export const dynamicImport = {
    data: {"origin":"caniuse","title":"JavaScript modules: dynamic import()","description":"Loading JavaScript modules dynamically using the import() syntax","chrome":"63","chrome_android":"142","firefox":"67","firefox_android":"144","url":"https://caniuse.com/es6-module-dynamic-import"},
	key: 'dynamicImport',
...
export const indexedDb = {
    data: {"origin":"caniuse","title":"IndexedDB 2.0","description":"Improvements to Indexed DB, including getAll(), renaming stores and indexes, and binary keys.","chrome":"58","chrome_android":"142","firefox":"51","firefox_android":"144","url":"https://caniuse.com/indexeddb2"},
	key: 'indexedDb',
	name: 'IndexedDB API',
	caniuse: 'indexeddb2',
	fn: (): boolean => {
...
export const customElements = {
    data: {"origin":"caniuse","title":"Custom Elements (V1)","description":"One of the key features of the Web Components system, custom elements allow new HTML tags to be defined.","chrome":"67","chrome_android":"142","firefox":"63","firefox_android":"144","url":"https://caniuse.com/custom-elementsv1"},
	key: 'customElements',
...
export const cssInset = {
    data: {"origin":"mdn","chrome":"87","chrome_android":"87","firefox":"66","firefox_android":"66","url":"https://developer.mozilla.org/docs/Web/CSS/Reference/Properties/inset"},
	key: 'cssInset',
	name: 'CSS inset',
...
export const cssDetailsContent = {
    data: {"origin":"mdn","chrome":"131","chrome_android":"131","firefox":"143","firefox_android":"143","url":"https://developer.mozilla.org/docs/Web/CSS/Reference/Selectors/::details-content"},
...
export const cssMathFunctions = {
    data: {"origin":"caniuse","title":"CSS math functions min(), max() and clamp()","description":"More advanced mathematical expressions in addition to `calc()`","chrome":"79","chrome_android":"142","firefox":"75","firefox_android":"144","url":"https://caniuse.com/css-math-functions"},
...
export const cssBoxShadow = {
    data: {"origin":"caniuse","title":"CSS3 Box-shadow","description":"Method of displaying an inner or outer shadow effect to elements","chrome":"10","chrome_android":"142","firefox":"4","firefox_android":"144","url":"https://caniuse.com/css-boxshadow"},
	key: 'cssBoxShadow',
	name: 'CSS box-shadow',
...
export const cssGrid = {
    data: {"origin":"caniuse","title":"CSS Grid Layout (level 1)","description":"Method of using a grid concept to lay out content, providing a mechanism for authors to divide available space for layout into columns and rows using a set of predictable sizing behaviors. Includes support for all `grid-*` properties and the `fr` unit.","chrome":"58","chrome_android":"142","firefox":"54","firefox_android":"144","url":"https://caniuse.com/css-grid"},
	key: 'cssGrid',
	name: 'CSS grid',
	caniuse: 'css-grid',
	fn: (): boolean => {
...
export const cssAspectRatio = {
    data: {"origin":"mdn","chrome":"88","chrome_android":"88","firefox":"89","firefox_android":"89","url":"https://developer.mozilla.org/docs/Web/CSS/Reference/Properties/aspect-ratio"},
	key: 'cssAspectRatio',
...
export const cssContainerType = {
    data: {"origin":"mdn","chrome":"105","chrome_android":"105","firefox":"110","firefox_android":"110","url":"https://developer.mozilla.org/docs/Web/CSS/Reference/Properties/container-type"},
...
export const cssSubgrid = {
    data: {"origin":"caniuse","title":"CSS Subgrid","description":"Feature of the CSS Grid Layout Module Level 2 that allows a grid-item with its own grid to align in one or both dimensions with its parent grid.","chrome":"117","chrome_android":"142","firefox":"71","firefox_android":"144","url":"https://caniuse.com/css-subgrid"},
	key: 'cssSubgrid',
	name: 'CSS subgrid',
	caniuse: 'css-subgrid',
	fn: (): boolean => {
...
export const cssRubyAlign = {
    data: {"origin":"mdn","chrome":"128","chrome_android":"128","firefox":"38","firefox_android":"38","url":"https://developer.mozilla.org/docs/Web/CSS/Reference/Properties/ruby-align"},
	key: 'cssRubyAlign',
	name: 'CSS ruby-align',
...
export const cssTextWrap = {
    data: {"origin":"mdn","chrome":"114","chrome_android":"114","firefox":"121","firefox_android":"121","url":"https://developer.mozilla.org/docs/Web/CSS/Reference/Properties/text-wrap"},
	key: 'cssTextWrap',
	name: 'CSS text-wrap',
...
export const cssDominantBaseline = {
    data: {"origin":"mdn","chrome":"1","chrome_android":"18","firefox":"1","firefox_android":"4","url":"https://developer.mozilla.org/docs/Web/CSS/Reference/Properties/dominant-baseline"},
...
export const cssFilter = {
    data: {"origin":"mdn","chrome":"53","chrome_android":"53","firefox":"35","firefox_android":"35","url":"https://developer.mozilla.org/docs/Web/CSS/Reference/Properties/filter"},
	key: 'cssFilter',
	name: 'CSS filter',
...
export const cssMixBlendMode = {
    data: {"origin":"mdn","chrome":"41","chrome_android":"41","firefox":"32","firefox_android":"32","url":"https://developer.mozilla.org/docs/Web/CSS/Reference/Properties/mix-blend-mode"},
	key: 'cssMixBlendMode',
...
export const cssRubyPosition = {
    data: {"origin":"mdn","chrome":"84","chrome_android":"84","firefox":"38","firefox_android":"38","url":"https://developer.mozilla.org/docs/Web/CSS/Reference/Properties/ruby-position"},
	key: 'cssRubyPosition',
...
export const cssScale = {
    data: {"origin":"mdn","chrome":"104","chrome_android":"104","firefox":"72","firefox_android":"79","url":"https://developer.mozilla.org/docs/Web/CSS/Reference/Properties/scale"},
	key: 'cssScale',
	name: 'CSS scale',
...
export const cssScrollbarWidth = {
    data: {"origin":"mdn","chrome":"121","chrome_android":"121","firefox":"64","firefox_android":"64","url":"https://developer.mozilla.org/docs/Web/CSS/Reference/Properties/scrollbar-width"},
...
export const cssScrollbarColor = {
    data: {"origin":"mdn","chrome":"121","chrome_android":"121","firefox":"64","firefox_android":"64","url":"https://developer.mozilla.org/docs/Web/CSS/Reference/Properties/scrollbar-color"},
...
export const cssUserSelect = {
    data: {"origin":"mdn","chrome":"54","chrome_android":"54","firefox":"69","firefox_android":"79","url":"https://developer.mozilla.org/docs/Web/CSS/Reference/Properties/user-select"},
	key: 'cssUserSelect',
...
export const cssZIndex = {
    data: {"origin":"mdn","chrome":"1","chrome_android":"18","firefox":"1","firefox_android":"4","url":"https://developer.mozilla.org/docs/Web/CSS/Reference/Properties/z-index"},
	key: 'cssZIndex',
	name: 'CSS z-index',
...
export const cssZoom = {
    data: {"origin":"caniuse","title":"CSS zoom","description":"Method of scaling content while also affecting layout.","chrome":"4","chrome_android":"142","firefox":"126","firefox_android":"144","url":"https://caniuse.com/css-zoom"},
	key: 'cssZoom',
	name: 'CSS zoom',
	caniuse: 'css-zoom',
	fn: (): boolean => {
...
export const cssWebkitTextStroke = {
    data: {"origin":"mdn","chrome":"4","chrome_android":"18","firefox":"49","firefox_android":"49","url":"https://developer.mozilla.org/docs/Web/CSS/Reference/Properties/-webkit-text-stroke"},
...
export const cssPaintOrder = {
    data: {"origin":"mdn","chrome":"123","chrome_android":"123","firefox":"60","firefox_android":"60","url":"https://developer.mozilla.org/docs/Web/CSS/Reference/Properties/paint-order"},
	key: 'cssPaintOrder',
...
export const cssInterpolateSize = {
    data: {"origin":"mdn","chrome":"129","chrome_android":"129","firefox":false,"firefox_android":false,"url":"https://developer.mozilla.org/docs/Web/CSS/Reference/Properties/interpolate-size"},
...
export const cssConicGradient = {
    data: {"origin":"mdn","chrome":"69","chrome_android":"69","firefox":"83","firefox_android":"83","url":"https://developer.mozilla.org/docs/Web/CSS/Reference/Values/gradient/conic-gradient"},
...
export const cssRelativeColors = {
    data: {"origin":"caniuse","title":"CSS Relative color syntax","description":"Relative color syntax in CSS allows a color to be defined relative to another color using the `from` keyword and optionally `calc()` for any of the color values.","chrome":"131","chrome_android":"142","firefox":"133","firefox_android":"144","url":"https://caniuse.com/css-relative-colors"},
...
export const cssOklch = {
    data: {"origin":"mdn","chrome":"111","chrome_android":"111","firefox":"113","firefox_android":"113","url":"https://developer.mozilla.org/docs/Web/CSS/Reference/Values/color_value/oklch"},
	key: 'cssOklch',
	name: 'CSS oklch()',
...
export const webAnimations = {
    data: {"origin":"caniuse","title":"Web Animations API","description":"Lets you create animations that are run in the browser, as well as inspect and manipulate animations created through declarative means like CSS.","chrome":"84","chrome_android":"142","firefox":"81","firefox_android":"144","url":"https://caniuse.com/web-animation"},
	key: 'webAnimations',
...
export const resizeObserver = {
    data: {"origin":"caniuse","title":"Resize Observer","description":"Method for observing and reacting to changes to sizes of DOM elements.","chrome":"64","chrome_android":"142","firefox":"69","firefox_android":"144","url":"https://caniuse.com/resizeobserver"},
	key: 'resizeObserver',
...
export const webSockets = {
    data: {"origin":"caniuse","title":"Web Sockets","description":"Bidirectional communication technology for web apps","chrome":"16","chrome_android":"142","firefox":"11","firefox_android":"144","url":"https://caniuse.com/websockets"},
	key: 'webSockets',
	name: 'WebSocket API',
	caniuse: 'websockets',
	fn: (): boolean => {
...
export const cssContentVisibility = {
    data: {"origin":"caniuse","title":"CSS content-visibility","description":"Provides control over when elements are rendered, so rendering can be skipped for elements not yet in the user's viewport. ","chrome":"85","chrome_android":"142","firefox":"125","firefox_android":"144","url":"https://caniuse.com/css-content-visibility"},
...
export const cssBackdropSelector = {
    data: {"origin":"mdn","chrome":"37","chrome_android":"37","firefox":"47","firefox_android":"47","url":"https://developer.mozilla.org/docs/Web/CSS/Reference/Selectors/::backdrop"},
...
export const cssTransitionBehavior = {
    data: {"origin":"mdn","chrome":"117","chrome_android":"117","firefox":"129","firefox_android":"129","url":"https://developer.mozilla.org/docs/Web/CSS/Reference/Properties/transition-behavior"},
...
export const cssCalcSize = {
    data: {"origin":"mdn","chrome":"129","chrome_android":"129","firefox":false,"firefox_android":false,"url":"https://developer.mozilla.org/docs/Web/CSS/Reference/Values/calc-size"},
	key: 'cssCalcSize',
	name: 'CSS calc-size()',
...
export const cssBackdropFilter = {
    data: {"origin":"caniuse","title":"CSS Backdrop Filter","description":"Method of applying filter effects (like blur, grayscale or hue) to content/elements below the target element.","chrome":"76","chrome_android":"142","firefox":"103","firefox_android":"144","url":"https://caniuse.com/css-backdrop-filter"},
...
export const cssStartingStyle = {
    data: {"origin":"mdn","chrome":"117","chrome_android":"117","firefox":"129","firefox_android":"129","url":"https://developer.mozilla.org/docs/Web/CSS/Reference/At-rules/@starting-style"},
...
export const cssRound = {
    data: {"origin":"mdn","chrome":"125","chrome_android":"125","firefox":"118","firefox_android":"118","url":"https://developer.mozilla.org/docs/Web/CSS/Reference/Values/round"},
	key: 'cssRound',
	name: 'CSS round()',
...
export const avif = {
    data: {"origin":"caniuse","title":"AVIF image format","description":"A modern image format based on the [AV1 video format](/av1). AVIF generally has better compression than [WebP](/webp), JPEG, PNG and GIF and is designed to supersede them. AVIF competes with [JPEG XL](/jpegxl) which has similar compression quality and is generally seen as more feature-rich than AVIF.","chrome":"85","chrome_android":"142","firefox":"113","firefox_android":"144","url":"https://caniuse.com/avif"},
	key: 'avif',
